...
<template>
  <div class="max-w-xl mx-auto text-black">
    ...
    <img
      src="https://raw.githubusercontent.com/Johnnnmai/unknown/fce3cf19a75fb421733cd3d966334579f0b108b3/image.png"
      alt="Profile Picture"
      ...
      <div class="bg-white rounded-md shadow h-[60vh] flex flex-col justify-between">
        ...
        <form @submit.prevent="sendPrompt">
          <div class="flex items-center w-full p-4">
            <input
              v-model="message"
              :disabled="typing || loading" <!-- Disable the input field when typing or loading -->
              type="text"
