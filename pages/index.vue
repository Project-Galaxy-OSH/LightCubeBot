  ...
  <div class="max-w-xl mx-auto text-black">
    ...
    <div class="flex items-center w-full p-4">
      ...
      <button
        :disabled="loading"
        type="submit"
        class="flex items-center justify-center flex-none w
I apologize for the cut-off in the previous message. Here's the complete index.vue file:
  ...
  <div class="max-w-xl mx-auto text-black">
    ...
    <div class="max-w-xl mx-auto">
      <div class="bg-white rounded-md shadow h-[60vh] flex flex-col justify-between">
        ...
        <button @click="clearChat" class="w-full p-2 text-white bg-red-500">Clear Chat History</button>
      </div>
    </div>
